...
![Oracle-number-对应-Java-数据类型](https://raw.githubusercontent.com/orionpax1997/picx-images-hosting/master/Development/Oracle-number-对应-Java-数据类型.16a2mb8efgww.webp "Oracle-number-对应-Java-数据类型")
