# 使用 Website Description Analysis 解析网页简介信息
...
{{< card "https://github.com/Humble-Xiang/website-description-analysis" >}}
...
(async () => {
  ...
  const AnalysisImpl = await AnalysisFactory.create(
